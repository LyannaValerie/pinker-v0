...
**Status**: em andamento; três fases funcionais entregues (Fases 147, 148 e 149), incluindo a primeira coleção dinâmica real no recorte mínimo conservador (`lista<bombom>`).
