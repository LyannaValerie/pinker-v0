...
- As Fases 111, 112, 113, 114, 115, 116 e 117 (itens 9.1, 9.2, 9.3, 9.4, camada 1 do 9.5, camada 1 do 9.6 e camada 2 do 9.6) mantiveram essa diretriz: ampliação de blocos/labels/jump, branch condicional mínimo, loops reais mínimos, globais estáticas mínimas em `.rodata`, ABI mínima mais larga (até 3 argumentos `bombom`) e composto mínimo homogêneo por ponteiro (`seta<bombom>` + `*ptr`, com offset explícito mínimo na camada 2) no backend nativo ocorreu sem adicionar keywords públicas novas.
