...
| 4 | Traits / interfaces mínimas | Rust, TS, C# | polimorfismo sem herança, contratos de driver — **expandido nas Fases 226–228**: `trato` como contrato estático, chamada por método, `impl Trato para Tipo { ... }` com receiver explícito e resolução nominal de método pelo tipo do receiver; fora: objetos de trait, vtables, dynamic dispatch e coerções |
