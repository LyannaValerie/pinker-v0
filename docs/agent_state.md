...
## 2. Estado corrente
- Fase funcional atual: **160 — formatação e dados estruturados: datas e tempo básicos com timestamp Unix mínimo (camada 1 conservadora)**.
...
- Bloco formal da trilha ativa: **14 — formatação e dados estruturados (aberto funcionalmente nas Fases 157, 158, 159 e 160)**.
