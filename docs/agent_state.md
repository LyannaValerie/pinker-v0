...
## 2. Estado corrente
- Fase funcional atual: **157 — formatação e dados estruturados: formatação simples de saída com placeholders mínimos (camada 1 conservadora)**.
...
- Bloco formal da trilha ativa: **14 — formatação e dados estruturados (aberto funcionalmente na Fase 157)**.
