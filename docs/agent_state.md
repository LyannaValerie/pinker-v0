...
## 2. Estado corrente
- Fase funcional atual: **167 — ferramenta cotidiana madura e linguagem-cola: REPL mínimo auditável (camada 1 conservadora)**.
...
- Escada interna do Bloco 16: **16.1 concluído no recorte mínimo (`pink repl`); 16.2 ainda não iniciado funcionalmente**.
