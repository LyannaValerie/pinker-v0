...
## 2. Estado corrente
- Fase funcional mais recente: **187 — core nobre e bibliotecas temáticas: importação mínima da família `ambiente`**.
...
- Camada atual do bloco em curso: **18 — recorte funcional mínimo de importação por família ampliado até a Fase 187 (18.6)**.
...
- Próximo passo provável no Bloco 18: avançar 18.6 com mais famílias importáveis ou abrir 18.7 (documentação identitária), dependendo do estado de maturidade canônica de cada família.
