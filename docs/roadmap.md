...
- O Bloco 11 está em progresso ativo: a Fase 137 abriu o primeiro recorte funcional do item 11.1 (`split`); a Fase 138 abriu o segundo recorte do item 11.2 (`replace` camada 1 conservadora) com `substituir_verso`; a Fase 139 abriu o terceiro recorte do item 11.3 (`join` camada 1 conservadora) com `juntar_verso_com`.
...
- A próxima rodada funcional esperada do Bloco 11 é avançar para 11.4 (busca textual mínima ou utilitários práticos de arquivo/caminho/ambiente).
