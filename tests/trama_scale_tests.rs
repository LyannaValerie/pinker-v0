...
// @pinker-nav:start evidence.trama.scale.fixture-config
// @pinker-nav:domain development
// @pinker-nav:layer support
// @pinker-nav:summary The DOC_TOML constant configures the documentary catalogs used by the synthetic scale fixtures.
...
"#;
// @pinker-nav:end evidence.trama.scale.fixture-config

// @pinker-nav:start evidence.trama.scale.process-support
// @pinker-nav:domain development
// @pinker-nav:layer support
// @pinker-nav:summary Four helpers create temporary repositories, write fixtures, run pink doc and produce extensive synthetic catalogs.
...
// @pinker-nav:end evidence.trama.scale.process-support

// @pinker-nav:start evidence.trama.scale.large-catalog
// @pinker-nav:domain development
// @pinker-nav:layer evidence
// @pinker-nav:summary Evidence of querying and lookup in a synthetic catalog with more than five thousand entries without an undue structural limit.
#[test]
...
// @pinker-nav:end evidence.trama.scale.large-catalog

// @pinker-nav:start evidence.trama.scale.deterministic-order
// @pinker-nav:domain development
// @pinker-nav:layer evidence
// @pinker-nav:summary Evidence of deterministic ordering when repeating bounded queries over a large-scale catalog.
#[test]
...
// @pinker-nav:end evidence.trama.scale.deterministic-order
