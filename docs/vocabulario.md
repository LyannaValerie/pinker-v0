...
- As Fases 120–122 no backend nativo externo também não introduziram keyword nova: abriram cobertura semântica mínima de tipos já existentes (`u32`/`u64`) e comparação ampliada mínima (`!=`) no caminho externo.
