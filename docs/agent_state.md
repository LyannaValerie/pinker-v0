...
- Frente ativa: **Bloco 11 — texto prático, scripts e ergonomia cotidiana** (item 11.3 aberto).
...
4. Próxima rodada normal esperada: avançar para 11.4 (utilitários práticos de arquivo/caminho/ambiente ou busca textual mínima), mantendo o editor/TUI pausado e sem reabrir o Bloco 10.
...
## 10. Direção estratégica atualizada (Fase 139)
...
- O Bloco 11 está em progresso ativo: a Fase 137 abriu `split` (item 11.1); a Fase 138 abriu `replace` (item 11.2); a Fase 139 abriu `join` (item 11.3) como camada 1 conservadora com `juntar_verso_com`.
- Próxima rodada funcional esperada: avançar para 11.4 (busca textual mínima ou utilitários práticos de arquivo/caminho/ambiente), conforme prioridade real.
