...
## 2. Estado corrente
- Fase funcional mais recente: **184 — core nobre e bibliotecas temáticas: domínio interno por intrínseca**.
...
- Próximo passo documental provável no Bloco 18: continuar a preparação do bloco a partir da relação agora explícita entre inventário, domínios internos, famílias públicas e superfície futura por família, sem fingir resolução qualificada já pronta.
