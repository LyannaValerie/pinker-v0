...
No estado funcional atual de 18.6, apenas `tempo` e `ambiente` estão importáveis via `trazer familia;`. As demais famílias públicas aceitas continuam apenas como organização documental/arquitetural.
