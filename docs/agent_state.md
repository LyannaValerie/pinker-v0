...
- Próximo passo funcional sugerido: **seguir refinamentos mínimos de tooling/I/O em `--run` no Bloco 8 com recorte pequeno e auditável (ex.: classificação complementar de caminho, sem abrir API ampla de filesystem)**.
...
- Rodada funcional corrente: **nenhuma aberta** (última fase funcional concluída é a Fase 96).
