...
- Frente ativa: **Bloco 11 — scripts, utilidade prática e ergonomia cotidiana**.
...
4. Próxima rodada normal esperada: abrir a primeira fase funcional do Bloco 11 em recorte pequeno e auditável, mantendo o editor/TUI pausado nesta transição e sem reabrir o Bloco 10 por impulso.
...
- O Bloco 11 foi aberto canonicamente como foco ativo imediato para scripts, utilidade prática e ergonomia cotidiana.
- Próxima rodada funcional esperada: primeira fase do Bloco 11, sem continuidade do editor/TUI nesta rodada documental.
