...
| Campo | Valor |
|---|---|
| Fase funcional mais recente | **243** — Eixo A: closures com captura imutável por valor |
...
- **Fase 243 — Eixo A, item 6 da Faixa 1: closures com captura imutável por valor**.
...
- A Fase 243 está mergeada. Qualquer avanço em captura mutável, captura por referência, recuperação de ambientes ou capturas multi-palavra deve definir antes ownership e lifetime, incluindo cópia/passagem/retorno de handles, compartilhamento de ambiente, momento de liberação e prevenção de double free, use-after-free e ponteiro para pilha expirada.
...
- O item 6 também pode avançar em funcionalidade após esses contratos; o item 5 pode avançar para diagnósticos enriquecidos ou métodos utilitários, e o item 4 permanece a continuação canônica de traits. Em qualquer caso, sem recorte mínimo automático, com lowering nativo obrigatório e com fatia vertical utilizável.
