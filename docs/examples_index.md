...
| importação por família | `examples/fase186_trazer_tempo_minimo_valido.pink`, `examples/fase187_trazer_ambiente_minimo_valido.pink`, `examples/fase188_trazer_acaso_minimo_valido.pink`, `examples/fase189_trazer_texto_minimo_valido.pink` | `tests/interpreter_tests.rs`, `tests/semantic_tests.rs` | `trazer familia;`, famílias built-in importáveis, rejeição de seletivo e famílias fora do recorte |
