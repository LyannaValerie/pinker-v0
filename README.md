...
- operações textuais além do recorte mínimo das Fases 137–139 (sem regex, sem busca de múltiplas ocorrências, sem `join` de coleção arbitrária, sem coleções gerais, sem biblioteca textual ampla)
