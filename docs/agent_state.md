...
4. Próxima rodada normal esperada: continuidade conservadora do item 9.6 em camada incremental pequena (sem abrir composto amplo, sem ABI composta e sem redesign de layout/memória).
