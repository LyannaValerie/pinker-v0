...
| `pink nav projecao listar` | Inventário do arquivo histórico materializado |
| `pink nav projecao mostrar ID` | Uma entrada do arquivo, com medidas preservadas e integridade |
| `pink nav projecao verificar [ID]` | Integridade do arquivo histórico, sem ler o catálogo corrente |
...
índice de arquivo inválido, preservando `5` para arquivo alterado e `3` para
payload ausente. A versão humana contém apenas
