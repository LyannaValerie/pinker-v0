...
- As Fases 111 e 112 (itens 9.1 e 9.2) mantiveram essa diretriz: ampliação de blocos/labels/jump e branch condicional mínimo ocorreu no backend nativo sem adicionar keywords públicas novas.
