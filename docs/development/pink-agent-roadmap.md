...
candidato, dogfood e retomada. A Onda D é próxima e separada: fecha a cadeia
operacional em trabalho próprio. `trama_complete = false`; Onda 9 inativa;
`apps/` reservada. Nenhuma onda ativa automaticamente a Onda 9.
