...
- coleções dinâmicas além do recorte mínimo atual de `lista<bombom>` (sem `lista<T>` ampla, sem mapa, sem remoção arbitrária/insert/sort e sem iteração confortável)
