...
## 2. Estado corrente
- Fase funcional atual: **158 — formatação e dados estruturados: CSV mínimo (camada 1 conservadora)**.
...
- Bloco formal da trilha ativa: **14 — formatação e dados estruturados (aberto funcionalmente nas Fases 157 e 158)**.
