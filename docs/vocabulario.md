...
- **Texto e expressão:** `verso`, `falar`, `juntar_verso`, `tamanho_verso`, `formatar_verso`, `ler_linha_csv_bombom`, `emitir_linha_csv_bombom`, `ler_json_plano_bombom`, `emitir_json_plano_bombom`.
