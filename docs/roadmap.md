...
**Estado atual**
Bloco aberto em camada documental/arquitetural. A Fase 180 abriu o inventário canônico de intrínsecas, a Fase 181 canonizou as famílias públicas iniciais, a Fase 182 formalizou `tempo` como família exemplar, a Fase 183 fixou a ponte documental entre superfície global legada e superfície futura por família, a Fase 184 formalizou o domínio interno por intrínseca e a Fase 185 preparou documentalmente a futura resolução qualificada por família, mantendo `colecao` e `formato` como domínios provisórios.
