...
- FFI geral, objetos de trait, vtables/dynamic dispatch, coerções de trait, default methods, overloading amplo de contratos, closures capturantes, funções como valores armazenáveis/passáveis e tipos-função públicos
