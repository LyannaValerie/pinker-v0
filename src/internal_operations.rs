...
// @pinker-nav:start internals.contract.authority
// @pinker-nav:domain contract
// @pinker-nav:layer compiler
// @pinker-nav:summary Single declarative authority of the compiler's internal operations (U-01): existence, family, operand roles, arity and IR signature of each internal spelling, deliberately separated from the callee class, from the public intrinsics surface and from the runtime's ABI symbol.
...
// @pinker-nav:end internals.contract.authority
