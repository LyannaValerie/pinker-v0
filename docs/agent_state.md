...
## 2. Estado corrente
- Fase funcional mais recente: **186 — core nobre e bibliotecas temáticas: importação mínima da família exemplar `tempo`**.
...
- Camada atual do bloco em curso: **18 — primeiro recorte funcional real aberto na Fase 186 (18.6)**.
