...
- Próxima fase: com closures com captura imutável por valor entregues na Fase 243 (checkpoint local, publicação separada pendente de revisão humana), o item 6 pode avançar para captura mutável, captura por referência ou coleta de lixo (nenhuma entregue nesta fase), o item 5 pode avançar para diagnósticos enriquecidos ou métodos utilitários (derivados do roadmap, não presumidos aqui), ou a trilha pode iniciar a Faixa 3 se a direção imediata for SO. Em qualquer caso, sem recorte mínimo automático, com lowering nativo obrigatório e com fatia vertical utilizável.
