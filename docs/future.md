...
- **exportação de tipos pelo sistema de módulos**: `ninho` e `apelido` já são exportáveis via `trazer` (Fases 144 e 145, camadas conservadoras), fechando o recorte mínimo do Bloco 12 para tipos compartilhados.
