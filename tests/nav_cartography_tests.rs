...
fn catalogo_real_cartografa_o_guardiao_pinker_da_onda_9() {
    ...
    // responsabilidade publicada, 644 -> 747; a extração lexical de símbolos da #680 e a sua região de evidência levam a 749. Nenhuma região foi retirada.
    ...
    assert_eq!(index.regions.len(), 749);
