...
## 2. Estado corrente
- Fase mais recente: **171 — forma visual e superfície documental: norma visual oficial mínima**.
...
- Leitura canônica do estado: a Fase 171 abriu o **Bloco 17** em camada documental, sem deslocar a frente funcional oficial do **Bloco 16**.
