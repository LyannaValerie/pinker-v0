...
| processos externos mínimos | `examples/fase161_processo_externo_minimo_valido.pink`, `examples/fase161_processo_externo_fluxo_composto_valido.pink`, `examples/fase163_captura_stdout_minima_valido.pink`, `examples/fase163_captura_stdout_fluxo_composto_valido.pink`, `examples/fase164_captura_stderr_minima_valido.pink`, `examples/fase164_captura_stderr_fluxo_composto_valido.pink` | `tests/interpreter_tests.rs`, `tests/semantic_tests.rs` | `executar_processo(comando)`, `capturar_stdout(comando)`, `capturar_stderr(comando)`, retorno de código, captura textual mínima de stdout/stderr, fluxo composto e portabilidade com binários auxiliares do repositório |
