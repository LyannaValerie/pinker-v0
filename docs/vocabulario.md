...
- **I/O, tooling e integração sistêmica mínima:** `ouvir`, `abrir`, `fechar`, `escrever`, `argumento`, `executar_processo`, `executar_com_entrada`, `capturar_stdout`, `capturar_stderr`, `sair`.
