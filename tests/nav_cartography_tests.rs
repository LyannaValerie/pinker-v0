...
fn catalogo_real_cartografa_o_guardiao_pinker_da_onda_9() {
    ...
    // responsabilidade publicada, 644 -> 747. Nenhuma região foi retirada.
    ...
    assert_eq!(index.regions.len(), 747);
