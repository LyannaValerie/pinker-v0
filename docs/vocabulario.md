...
- As Fases 120 e 121 (inteiros mais largos no backend nativo externo) também não introduziram keyword nova: abriram cobertura semântica mínima de tipos já existentes (`u32` e `u64`) no caminho externo.
