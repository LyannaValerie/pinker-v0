...
- **I/O, tooling e integração sistêmica mínima:** `ouvir`, `abrir`, `fechar`, `escrever`, `argumento`, `executar_processo`, `capturar_stdout`, `capturar_stderr`, `sair`.
