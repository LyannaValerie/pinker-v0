...
- coleções básicas além do recorte já aberto de `lista<bombom>` (núcleo atual: criar/anexar/obter/tamanho/definir; segue fora lista ampla/mapa/dicionário/iteração mais confortável);
