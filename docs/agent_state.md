...
4. Próxima rodada normal esperada: avaliar encerramento conservador de 10.4 após a Fase 132, ou abrir 10.5 (`virar`) com recorte mínimo e auditável, sem antecipar 10.6 (`verso`).
