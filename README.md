...
Status documental corrente: **Fase 134 avançou o item 10.5 do Bloco 10** com camada 2 conservadora de `virar` no backend nativo externo (cast operacional mínimo explícito `u32 -> u64` e `u64 -> u32`, ambos com origem em slot local/parâmetro), mantendo tese de **cobertura semântica do backend nativo** (sem prometer backend pleno).
