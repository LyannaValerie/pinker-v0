...
Status documental corrente: **Fase 129 abriu o item 10.4 do Bloco 10** com camada 1 conservadora de `ninho` heterogêneo mínimo no backend nativo externo, mantendo tese de **cobertura semântica do backend nativo** (sem prometer backend pleno).
