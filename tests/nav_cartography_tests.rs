...
fn onda_8f_cartografa_evidencias_do_backend_textual() {
    ...
    assert_eq!(
        ...
        (166_075, 10_551_378_569_927_223_796),
...
fn onda_8g_cartografa_evidencias_do_backend_s_textual() {
    ...
    assert_eq!(
        ...
        (169_826, 14_536_959_254_021_383_364),
...
fn capsula_nav_catalog_cartografa_suporte_e_seis_testes() {
    ...
    assert_eq!(
        ...
        (192_709, 14_898_265_473_089_000_833)
    );
    ...
    assert_eq!(
        ...
        (194_446, 8_131_314_113_921_474_714)
    );
...
fn capsula_doc_catalog_cartografa_suporte_e_quatro_testes() {
    ...
    assert_eq!(
        (full_projection.len(), fnv1a64(full_projection.as_bytes())),
        (196_111, 13_233_091_085_143_403_345),
...
fn onda_8h_cartografa_evidencias_da_toolchain_externa() {
    ...
    assert_eq!(
        ...
        (172_687, 3_954_810_198_400_606_227),
...
fn onda_8i_cartografa_evidencias_e_paridade_do_backend_nativo() {
    ...
    assert_eq!(
        ...
        (179_196, 18_122_197_115_720_973_518),
...
fn onda_8j_cartografa_evidencias_internas_do_runtime() {
    ...
    assert_eq!(
        helpers.len(),
        12,
        "o bloco de testes deve conter exatamente doze helpers, obteve {helpers:?}"
    );
    for expected in [
        "fn filho_stdout(",
        "fn script_processo(",
    ...
    assert_eq!(
        ...
        (186_892, 10_608_928_701_639_566_622),
...
fn capsula_trama_query_cartografa_suporte_e_dez_testes() {
    ...
    assert_eq!(
        (full_projection.len(), fnv1a64(full_projection.as_bytes())),
        (198_426, 12_711_093_865_055_746_898),
...
fn onda_pink_agente_a_cartografa_nucleo_e_primeiro_dogfood() {
    ...
    for (regions, expected) in [
        (
            post_query.as_slice(),
            (428, 196_111, 13_233_091_085_143_403_345),
        ),
        (
            post_nav.as_slice(),
            (422, 194_446, 8_131_314_113_921_474_714),
        ),
        (
            wave_8.as_slice(),
            (416, 192_709, 14_898_265_473_089_000_833),
        ),
    ] {
    ...
    assert_eq!(
        (full_projection.len(), fnv1a64(full_projection.as_bytes())),
        (204_698, 4_741_388_944_105_291_863),
...
fn onda_pink_agente_b_verifica_integridade_e_dogfood_operacional() {
    ...
    assert_eq!(
        ...
        (208_737, 14_844_651_954_440_250_268),
    ...
    assert_eq!(
        ...
        (456, 204_698, 4_741_388_944_105_291_863)
    );
    ...
    assert_eq!(
        ...
        (437, 198_426, 12_711_093_865_055_746_898)
    );
    ...
    let n: Vec<_> = d
        ...
        .collect();
    for (regions, expected) in [
        (q.as_slice(), (428, 196_111, 13_233_091_085_143_403_345)),
        (d.as_slice(), (422, 194_446, 8_131_314_113_921_474_714)),
        (n.as_slice(), (416, 192_709, 14_898_265_473_089_000_833)),
    ] {
        let projection = stable_region_projection(regions.iter().copied());
        assert_eq!(
            (
...
fn onda_pink_agente_c_publica_retoma_e_cartografa_trama_restante() {
    ...
    assert_eq!(
        (full.len(), fnv1a64(full.as_bytes())),
        (212_658, 13_337_298_225_701_044_972),
    ...
    assert_eq!(
        ...
        (470, 208_737, 14_844_651_954_440_250_268)
    );
    let core = include_str!("../src/agent.rs");
    for contract in [
        "run_pr_body_check",
...
fn onda_pink_agente_d_congela_v1_sem_fechar_trama() {
    ...
    assert_eq!(
        (full.len(), fnv1a64(full.as_bytes())),
        (213_110, 3_426_314_293_174_434_088),
    ...
    assert_eq!(
        ...
        (483, 212_658, 13_337_298_225_701_044_972),
