...
/// SHA-256 na forma canônica de 64 caracteres hexadecimais minúsculos.
///
/// O núcleo vive em `pinker_sha256_contract` desde a Parte E2, porque o runtime
/// nativo não pode depender deste crate e duas implementações do mesmo
/// algoritmo divergiriam em silêncio. Continua exposta aqui com a mesma
/// assinatura: o contrato de que existe **uma** implementação de SHA-256 no
/// repositório não mudou de conteúdo, só de endereço.
pub use pinker_sha256_contract::sha256_hex;
